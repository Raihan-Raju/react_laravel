         ...
         <div className="row">
            ...
            <div className="col-10">
               ...
               <div className="border border-info rounded-3 p-3">
                ...
                Vat: <input type="number" name="Price" className="form-control p-2" />
                Discount: <input type="number" name="Price" className="form-control p-2" />
                Seles Price: <input type="number" name="Price" className="form-control p-2" />
