...
{/* -----invoice-------- */}
         <form action method="post" >
                <div className="row col col-md-12">
                    <div className="row col col-md-12 font-weight-bold">
                    <div className="col col-md-2" htmlFor="items Name">Items Name:</div>
                    <div className="col col-md-2" htmlFor="Catagory">Catagory</div>
                    ...
                    <div className="col col-md-2" htmlFor="Vat">Vat</div>
                    {/* <div class="col col-md-2"for="Action">Action</div> */}
                    </div>
                </div>
                <div className="row col col-md-12">
                    <div className="row col col-md-12 font-weight-bold">
                    <div className="col col-md-2"><input id="items Name" type="text" className="form-control" name="items Name" placeholder="items Name" /></div>
                    <div className="col col-md-2"><input id="Catagory" type="text" className="form-control" name="Catagory" placeholder="Catagory" /></div>
                    ...
                    <div className="col col-md-2"><input id="Vat" type="text" className="form-control" name="Vat" placeholder="Vat" /></div>
